...
void writeMTL(const std::vector<std::string>& textureFiles, const std::string& fileName)
{
	...
	if(!filestr.is_open())
	{
		std::cerr << "[ObjWriter::" << __FUNCTION__ << "] ERROR: Could not open file for MTL: '" << fileName << "'!\n";
		return;
	}
...
bool ObjWriter::writeFile(const std::string& rFilename, const std::vector<sVertexProperties>& rVertexProps, const std::vector<sFaceProperties>& rFaceProps, MeshSeedExt& rMeshSeed)
{
	...
	if( !filestr.is_open() ) {
		cerr << "[ObjWriter::" << __FUNCTION__ << "] ERROR: Could not open file: '" << rFilename << "'!" << '\n';
		return false;
	} else {
		cout << "[ObjWriter::" << __FUNCTION__ << "] File open for writing: '" << rFilename << "'." << '\n';
	}
	filestr << "#===============================================================================" << '\n';
	...
	cout << "[ObjWriter::" << __FUNCTION__ << "] write ASCII OBJ:      " << static_cast<float>( clock() -timeStart ) / CLOCKS_PER_SEC << " seconds. " << '\n';
